---
name: concurrency-java25-review
description: >
  Review Java 25 concurrency for thread safety, race conditions, deadlocks,
...
- Rahman, A.N.M. Bazlur. *Modern Concurrency in Java*. O'Reilly Media, 2026. (Foundational text for Java concurrency, Virtual Threads, Scoped Values, and execution models).
